...
def main() -> None:
    ...
    parser_snapshot_info = subcommands.add_parser("snapshot-info", description="Information about current snapshot")
    parser_snapshot_info.add_argument("-o", "--output", type=argparse.FileType("w"), default=sys.stdout, help="Optional output file in which to write snapshot information")
